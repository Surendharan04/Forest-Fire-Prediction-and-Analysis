...
model = joblib.load('C:/Users/SPIRO-PYTHON/Desktop/Forest-Fire-Prediction-master/Deploy/latest/new/RandomForestClassifier.pkl')
...
def predict_view(request):
    if request.method == 'POST':
        print('IF')
        fieldss = ['Temperature', 'RH', 'Ws', 'Rain', 'FFMC', 'DMC', 'DC', 'ISI', 'BUI','FWI']
        ...
        output = prediction[0]
        if output == 'fire':
            output = 'The forest may set fire be alert'
        elif output == 'not fire':
            output = 'The forest is out of danger'
